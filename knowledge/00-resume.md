<!-- GENERATED FILE — do not edit by hand.
     Source: config/content.js   Rebuild: npm run ingest -->

# Who he is

Ramakrishnan S — AI-Driven Digital Marketing | SEO, AEO & GEO | Content Strategy & Marketing Automation.
Based in Chennai, Tamil Nadu.
Contact: ramakrishnan15126@gmail.com, +91 8124806650.
LinkedIn: https://linkedin.com/in/ramakrishnan15126 · GitHub: https://github.com/ram15126
...
He does not write code himself. He specifies the system, directs AI-assisted
development, and verifies every output before it reaches a client. The
specification, the judgement calls and the verification are his; the typing is
not. This is how he ships marketing tools, automations and AI creative without
a developer.

# Role: Co-Founder at NeoArk Digital

NeoArk Digital · Chennai, Tamil Nadu · Jan 2026 – Present.
All three of his roles run concurrently and are all current.
...
# Role: Marketing & SEO Intern at Siva Comics

Siva Comics · Chennai, Tamil Nadu · Jun 2026 – Present.
All three of his roles run concurrently and are all current.
...
# Role: Marketing Intern at Digimabble

Digimabble · Belgium (Remote) · Jan 2026 – Present.
All three of his roles run concurrently and are all current.
...
# Project: Multi-Brand SEO / AEO / GEO Agent System

Claude Code skill · 1 router, 37 playbooks, 78 collectors.
...
# Project: Free Website SEO Audit Tool

Shipped on a client Next.js site.
...
# Project: The State of Chennai SME Websites 2026

Original research · OpenStreetMap / Overpass API.
...
# Project: Seven Reusable AI Skills

Claude Code skills built from processes run manually first.
...
Prompt-based terminal video editor.
...
# Skills: Marketing, Content & Search

Self-assessed strengths in this area (his own rating out of 5, not a
measured metric): SEO / AEO / GEO 5/5, Content Strategy 5/5, Demand Generation 4/5, Keyword Research 4/5, GA4 & Search Console 3/5.

Everything else he lists here: Technical SEO, On-Page SEO, AEO & GEO, AI citability & llms.txt, Topical authority, maps & clustering, Information gain, Keyword research & search intent, Content briefs & editorial planning, Growth & demand generation, B2B SaaS marketing, Lead generation & cold email outreach, LinkedIn & social media marketing, Brand strategy & positioning, Competitor & market analysis, Google stack (GA4, Search Console, Ads, Keyword Planner), Meta Ads, Funnel analysis & CRO, Performance metrics (CTR, CPC, CPA, ROAS).

# Skills: AI & Automation

Self-assessed strengths in this area (his own rating out of 5, not a
measured metric): AI Agent Orchestration 5/5, Claude Code / Codex / Cursor 5/5, Prompt & Context Engineering 5/5, n8n & MCP Workflows 4/5, Generative Video Production 4/5.

Everything else he lists here: Agentic coding (Claude Code, Codex, Cursor, Antigravity), Multi-agent systems & agent routing, AI skill authoring, MCP integrations, n8n workflow automation, APIs & webhooks, Prompt & context engineering, AI output verification, Generative video (Higgsfield, Veo, Seedance), Voice & avatar (ElevenLabs, HeyGen), Image generation (Nano Banana), Motion graphics (Remotion), Web stack (HTML, CSS, Node.js, SQL), Git, Vercel, Supabase.

# Skills: Leadership & Delivery

Self-assessed strengths in this area (his own rating out of 5, not a
measured metric): Team Leadership 4/5, Client Communication 5/5, Coaching & Mentoring 4/5, Learning Agility 5/5, Stakeholder Reporting 4/5.

Everything else he lists here: Team leadership & delegation, Coaching, mentoring & onboarding, Client communication & account management, Requirement gathering & scoping, Stakeholder reporting, Quality assurance & process documentation, Cross-cultural remote collaboration, Creative problem solving, Learning agility & rapid upskilling.

# Education

B.Com, Marketing Management, D.G. Vaishnav College, Chennai, Tamil Nadu (2024 – 2027 (Expected)).
